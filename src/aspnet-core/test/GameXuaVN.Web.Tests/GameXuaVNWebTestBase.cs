...
{
    public abstract class GameXuaVNWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GameXuaVNWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GameXuaVNWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GameXuaVNDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GameXuaVNDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GameXuaVNDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GameXuaVNDbContext, Task<T>> func)
        {
            T result;
